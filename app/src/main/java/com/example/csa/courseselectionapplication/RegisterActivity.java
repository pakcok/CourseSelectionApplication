...
public class RegisterActivity extends Activity {
    ...
    private EditText inputStudnetID;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputStudnetID = (EditText) findViewById(R.id.reg_student_id);
        ...
        */
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                String studentid = inputStudnetID.getText().toString();

                if (!username.isEmpty() && !studentid.isEmpty() && !password.isEmpty()) {
                    registerUser(username, studentid, password);
                } else {
     ...
     * */
    private void registerUser(final String username, final String student_id,
