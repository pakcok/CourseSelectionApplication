...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "foo@example.com:hello", "bar@example.com:world", ":", "Android:MyNewPass"
    };
    /**
    ...
    private void attemptLogin() {
        ...
        */
        ...
        if (cancel) {
            ...
            Intent startHomePage= new Intent(LoginActivity.this, MainPage.class);
    ...
    */
    ...
    private void showProgress(final boolean show) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            mTitleTextView.setVisibility(show ? View.GONE : View.VISIBLE);
            mTitleTextView.animate().setDuration(shortAnimTime).alpha(
                    show ? 0 : 1).setListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationEnd(Animator animation) {
                    mTitleTextView.setVisibility(show ? View.GONE : View.VISIBLE);
